...
@Component
public class BuyerConcludedContractsBean {

	private static final Logger LOGGER = LogManager.getLogger(BuyerConcludedContractsBean.class);
	...
	@Autowired
	public BuyerConcludedContractsBean(MongoClient mongoClient) {
	...
	public void process(@Header("personid") String personid, Exchange exchange) throws Exception {
		...
		List<DataContract> list = dataContractDAO.findBuyerConcludedContracts(personid);
