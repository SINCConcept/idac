...
@Component
public class BuyerOpenContractsBean {

	private static final Logger LOGGER = LogManager.getLogger(BuyerOpenContractsBean.class);
	...
	@Autowired
	public BuyerOpenContractsBean(MongoClient mongoClient) {
	...
	public void process(@Header("personid") String personid, Exchange exchange) throws Exception {
		...
		List<DataContract> list = dataContractDAO.findBuyerOpenContracts(personid);
