...
@Component
public class ProviderConcludedContractsBean {

	private static final Logger LOGGER = LogManager.getLogger(ProviderConcludedContractsBean.class);
	...
	@Autowired
	public ProviderConcludedContractsBean(MongoClient mongoClient) {
	...
	public void process(@Header("personid") String personid, Exchange exchange) throws Exception {
		...
		List<DataContract> list = dataContractDAO.findProviderConcludedContracts(personid);
