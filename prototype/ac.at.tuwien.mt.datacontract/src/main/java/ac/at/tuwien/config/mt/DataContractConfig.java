 ...
 * 
 */
package ac.at.tuwien.config.mt;
 ...
 */
@Configuration
@ComponentScan("ac.at.tuwien.mt.datacontract")
@PropertySource({ "classpath:mongo_db.properties" })
@EnableScheduling
public class DataContractConfig extends CamelConfiguration implements InitializingBean {

	private static final Logger LOGGER = LogManager.getLogger(DataContractConfig.class);
	...
	protected void setupCamelContext(CamelContext camelContext) throws Exception {
		// setup the further components if necessary
	}
