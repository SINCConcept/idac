...
package ac.at.tuwien.mt.servicehandler.config;
...
@EnableScheduling
public class MiddlewareConfig extends CamelConfiguration implements InitializingBean {

	private static final Logger LOGGER = LogManager.getLogger(MiddlewareConfig.class);
