 ...
 * 
 */
package ac.at.tuwien.mt.client.rest.monitoring;
...
import ac.at.tuwien.mt.model.exception.CommunicationException;
...
public class RESTMonitoringClient {
	...
	public static MonitoredDataContract findMonitoredDataContract(String contractId) throws CommunicationException {
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(WebServicesProvider.getString(WebServiceProperty.REST_MIDDLEWARE_BASEURL))
		...
		MonitoredDataContract result = (MonitoredDataContract) DefaultJSONProvider.getObjectFromJson(responseAsString, MonitoredDataContract.class);
		return result;
	}
