...
package config.ac.at.tuwien.mt;
...
@PropertySource({ "classpath:mongo_db_test.properties" })
@EnableScheduling
public class CommonTestConfig extends CamelConfiguration implements InitializingBean {

	private static final Logger LOGGER = LogManager.getLogger(CommonTestConfig.class);
	...
	public PropertiesComponent properties() {
		String[] locations = new String[] { "classpath:webservices.properties", "classpath:mongo_db_test.properties" };
	...
	@Bean
	public MongoClient mongoDatabase(@Value("${mongo_db_user_name}") String username, @Value("${mongo_db_user_password}") String password, //
