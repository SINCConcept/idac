 ...
 *
 */
public class MongoDBPropertiesProvider {

	private static final ResourceBundle BUNDLE = ResourceBundle.getBundle("mongo_db_test");
	 ...
	 */
	public static String getString(MongoDBProperty property) {
	 ...
	 */
	public static int getInteger(MongoDBProperty property) {
		String valueAsString = BUNDLE.getString(property.getProperty());
	 ...
	 */
	public static boolean getBoolean(MongoDBProperty property) {
		String valueAsString = BUNDLE.getString(property.getProperty());
