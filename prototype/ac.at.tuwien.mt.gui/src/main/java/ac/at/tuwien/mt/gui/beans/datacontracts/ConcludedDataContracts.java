...
@ManagedBean(name = "concluded_dc_list")
@ViewScoped
public class ConcludedDataContracts implements Serializable {

	private static final Logger LOGGER = LogManager.getLogger(ConcludedDataContracts.class);
	...
	public void init() {
		...
		try {
			...
			list.addAll(client.findProviderConcludedContracts(personId));
			list.addAll(client.findBuyerConcludedContracts(personId));
