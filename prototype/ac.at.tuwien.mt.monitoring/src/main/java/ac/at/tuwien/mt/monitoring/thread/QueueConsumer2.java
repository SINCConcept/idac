 ...
 *
 */
public class QueueConsumer2 implements Runnable {

	private static final Logger LOGGER = LogManager.getLogger(QueueConsumer2.class);
	...
	public QueueConsumer2(Session session, Destination destination, Thing thing, List<DataContract> dataContracts, ThingMonitorQoDDAO thingMonitorQoDDAO, ThingMonitorQoSDAO thingMonitorQoSDAO,
